        ...
        <div className="main-navbar">
          <div className="main-navbar-wrapper">
            ...
            <div className="navbar-btns">
              <button onClick={setShowLogin} className="navbar-btn-1"><img src={lockIcon} />Login</button>
              <button onClick={setShowJoin} className="navbar-btn-2">Join Community</button>
            </div>
          </div>
      </div>
