    ...
    return (
        <div className="create-profile step-one">
            ...
            <div className="row form-field submit">
                ...
                <div className="col-6">
                    <button className="common-style-btn">I am Excited, Take me to Next Step</button>
                </div>
            </div>
            <div className="text-end skip" type="button">skip for now</div>
        </div>
    );
}
    ...
    return (
        <div className="step-two">
            ...
            <div className="create-profile">
                ...
                <div className="text-center"><button className="common-style-btn" type='button'>Just One More Step, Yes Continue</button></div>
                <div className="text-center skip" type="button">skip for now</div>
            </div>
        </div>
    );
}
